...
INSERT INTO parfum( nom_parfum, prix_parfum, volume_id, type_parfum_id, conditionnement, description, fournisseur, marque, stock ,image) VALUES
                    ...
                    ('Invictus 200ml', 200.75, 3, 2, 'flacon aluminium','Parfum Invicus', 'la maison Paco Rabanne', 'Paco Rabanne',5, 'invicus-200ml.jpg'),
                    ('Miss Dior 50ml', 222.0, 1, 1, 'flacon verre','Parfum miss dior', 'Dior', 'Dior',25, 'missdior-50ml.jpg'),
                    ('tresor 200ml', 258.0, 3, 1, 'flacon verre','tresor parfum', 'Lancôme', 'Lancôme',20, 'tresor.jpeg'),
                    ('working girl 50ml', 255.0, 1, 1,'flacon verre', 'girl parfum', 'jspp', 'working',2, 'working_girl_50ml.jpeg');
